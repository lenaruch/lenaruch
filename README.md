...
<img align="right" height="300" src="https://media.giphy.com/media/Y4ak9Ki2GZCbJxAnJD/giphy.gif"  />
...
<tr><td><a href="https://github.com/lenaruch/notes_app">Приложение заметки</a></td><td>Необходимо написать проект, содержащий функционал работы с заметками.
Программа должна уметь создавать заметку, сохранять её, читать список
заметок, редактировать заметку, удалять заметку.</td><td>Python</td></tr>
